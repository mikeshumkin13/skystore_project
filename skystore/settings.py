...
SECRET_KEY = "django-insecure-_y-nhk*%0whnazvmp!u$-d5nsh%$d&9&k_8=+09(qnt)qc^r%8"
...
# Путь для доступа к статическим файлам
STATIC_URL = "static/"

# Путь, где будут лежать статические файлы проекта
import os
